...
{
    public abstract class ZetaTimeoutWorkerBase : ZetaLoopWorkerBase, IZetaTimeoutWorker
    {
        #region Constants
        ...
        protected ZetaTimeoutWorkerBase(TimeSpan initialTimeout)
        {
            this.CheckTimeoutArgument(initialTimeout);
            _timeout = initialTimeout;
        }

        protected ZetaTimeoutWorkerBase(int initialMillisecondsTimeout)
        ...
        protected override void Shutdown(ZetaWorkerState shutdownState)
        {
        ...
        public TimeSpan Timeout
        {
            get
            {
                ...
                {
                    this.CheckState("Timeout value 'get' is requested.", ZetaWorkingExtensions.NonDisposedStates);
                    result = _timeout;
                });
            ...
            set
            {
                ...
                this.InvokeWithControlLock(() =>
                {
                    this.CheckState("Timeout value 'set' is requested.", ZetaWorkingExtensions.NonDisposedStates);
                    _timeout = value;
