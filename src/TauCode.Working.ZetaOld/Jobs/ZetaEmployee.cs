...
{
    // todo clean up
    internal class ZetaEmployee : ZetaWorkerBase
    {
        #region Fields
        ...
        internal ZetaEmployee(ZetaVice vice)
        {
            _vice = vice;
            _job = new ZetaJob(this);
        ...
        private void CheckStopped(string preamble)
        {
            ...
            this.CheckState(preamble, ZetaWorkerState.Stopped);
        }
        ...
        {
            if (this.State == ZetaWorkerState.Disposed)
            {
        ...
        private void EndJob(Task task)
        {
            ...
            //    if (this.State == ZetaWorkerState.Running)
            //    {
            //        this.Stop();
            //    }
            //});
