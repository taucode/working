...
{
    // todo clean up
    internal class ZetaVice : ZetaLoopWorkerBase
    {
        #region Constants
        ...
        private readonly Dictionary<string, ZetaEmployee> _employees;
        private readonly object _lock;
        ...
        internal ZetaVice()
        {
            ...
            _employees = new Dictionary<string, ZetaEmployee>();
            _lock = new object();
        }
        ...
        protected override Task<WorkFinishReason> DoWorkAsyncImpl()
        {
            ...
            var employeesToWakeUp = new List<ZetaEmployee>();
        ...
        internal IJob CreateJob(string jobName)
        {
            return this.GetWithControlLock(() =>
            {
                ...
                lock (_lock)
                {
                    ...
                    var employee = new ZetaEmployee(this)
                    {
                        Name = jobName,
                    };
